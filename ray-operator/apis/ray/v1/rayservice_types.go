...
const (
	ZeroDowntime UpgradeStrategy = "zero-downtime"
	NoStrategy   UpgradeStrategy = "no-strategy"
)
...
type RayServiceSpec struct {
	...
	// UpgradeStrategy represents the strategy used when upgrading the RayService. Currently supports `zero-downtime` and `no-strategy`
